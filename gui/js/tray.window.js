...
const popoverBounds = (wantedWidth, wantedHeight, trayposition, workArea, display) => {
...
module.exports = class TrayWM extends WindowManager {
  ...
  placeWithTray (wantedWidth, wantedHeight, trayposition) {
    ...
    try {
      popover.newBounds = popoverBounds(wantedWidth, wantedHeight, trayposition, workArea, display)
